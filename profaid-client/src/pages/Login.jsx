...
const roleDescriptions = {
    Student: 'Ask and check doubts in your department',
    Professor: 'Reply and Clarify the your subject doubts',
    Admin: "Manage Professors and Doubt's replies",
};
  ...
  return (
    <div className="prof-aid-bg-full d-flex flex-column">
      ...
      <div className="flex-grow-1 d-flex flex-column align-items-center justify-content-center p-3 p-md-5">
        <div className="text-center mb-2 text-white"> {/* 🎯 Reduced mb-5 to mb-4 */}
            ...
            <p className="fs-6 mt-3" style={{textShadow: '0 1px 2px rgba(0,0,0,0.4)'}}>
                Can you please tell ProfAid why are you here for ?
            </p>
        </div>
      ...
      <footer className="w-100 py-3 text-center text-white small" style={{ backgroundColor: 'rgba(255, 255, 255, 0.1)', marginTop: 'auto' }}>
        <Container>
          <p className="mb-0" style={{textShadow: '0 1px 2px rgba(0,0,0,0.4)'}}>If any queries/issues regarding ProfAid : Please contact <a href="mailto:john.admin@example.com" className="text-white">john.admin@example.com</a></p>
          <p className="mb-0" style={{textShadow: '0 1px 2px rgba(0,0,0,0.4)'}}>
             &copy; {new Date().getFullYear()} ProfAid Doubt Solving Platform. All rights reserved.
          </p>
        </Container>
      </footer>
    </div>
